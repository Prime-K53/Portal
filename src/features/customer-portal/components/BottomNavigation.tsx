...
export const BottomNavigation: React.FC<BottomNavigationProps> = ({
  ...
  return (
    <nav
      ...
      className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-xl border-t border-slate-200/60 shadow-[0_-4px_20px_rgba(0,0,0,0.06)] pt-1.5 pb-[calc(0.375rem+env(safe-area-inset-bottom,0px))] bottom-nav-print-hide"
    >
              ...
              <div className={`relative flex items-center justify-center w-8 h-8 rounded-full transition-colors ${
                ...
                {tab.badge !== undefined && tab.badge > 0 && (
                  <span
                    ...
                    } text-white text-[9px] font-black min-w-[16px] h-4 px-1 rounded-full flex items-center justify-center border-2 border-white shadow-2xs leading-none`}
                  >
