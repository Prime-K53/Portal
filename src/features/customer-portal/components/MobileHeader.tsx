...
export const MobileHeader: React.FC<MobileHeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-xl border-b border-slate-200/50 pt-safe bottom-nav-print-hide">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-2 sm:py-2.5 lg:py-3 flex items-center justify-between gap-2 sm:gap-3">
        {/* Left — Logo + Title */}
        <div className="flex items-center gap-2 sm:gap-2.5 min-w-0 flex-1">
          ...
          <div className="min-w-0">
            <h1 className="font-black text-sm sm:text-base text-slate-900 tracking-tight leading-none truncate">
              Prime <span className="text-blue-600">PORTAL</span>
            </h1>
            <p className="hidden sm:block text-[10px] sm:text-[11px] font-medium text-slate-500 leading-tight">Smart. Simple. School Supplies.</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-0 sm:gap-1 shrink-0">
          ...
          >
            ...
            {unreadCount > 0 && (
              <span className="absolute top-0 right-0 min-w-[16px] h-4 px-1 bg-rose-500 text-white text-[9px] font-black rounded-full flex items-center justify-center ring-2 ring-white leading-none">
