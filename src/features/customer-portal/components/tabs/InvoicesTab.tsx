            ...
            return (
              ...
              >
                ...
                <div className="pt-2 flex flex-col xs:flex-row xs:items-center xs:justify-between gap-2">
                  <span className="text-[12.5px] text-slate-500 font-medium truncate min-w-0">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <button
                      ...
                      className="px-3 sm:px-3.5 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 disabled:opacity-60 text-white font-extrabold text-xs shadow-xs flex items-center gap-1.5 transition min-h-[36px]"
                    >
                    ...
                    {isPayable && canRequestPayment(inv) && (
                      <button
                        ...
                        className="px-3 sm:px-3.5 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-extrabold text-xs shadow-xs flex items-center gap-1.5 transition min-h-[36px]"
                      >
